...
export default function ContactUs() {
  ...
  const { containerRef, handleScroll: globalHandleScroll } =
    useScrollablePage();
  ...
  const locations: LocationData[] = [
    ...
    },
    {
      name: "Ahmedabad",
      country: "India",
      coordinates: [72.52, 23.037], // More precise for Prahlad Nagar area
      address:
        "No.805A, Pinnacle Business Park,Corporate Road, Prahlad Nagar, Ahmedabad - 380015",
    ...
    },
    {
      name: "Chennai",
      country: "India",
      coordinates: [80.234, 13.0418], // More precise for T.Nagar area
      address:
        "Mena Kempala Arcade, 7A, 7th floor, A Block, New No. 18 & 20 (Old No. 113), Sir Theeagaraya Road, T.Nagar, Chennai – 600 017",
      phone: "+91-44-42075580",
      fax: "+91-44-42075581",
    },
    {
      ...
      address:
        "Unit no. 220, Suncity Trade Tower, Sector 21, Near Krishna Chowk Gurgaon-122001, India",
      phone: "+91-44-42075580",
      fax: "+91-44-42075581",
    },
    {
      ...
      address:
        "SL Jubilee, 3rd Floor, Office No.304 Regus Eversun Business Centre Pvt Ltd, Plot No 1201 & 1215A, Road No.36 Jubile Hills, Hyderabad - 500034",
      phone: "+91-44-42075580",
      fax: "+91-44-42075581",
    },
    {
      ...
      address:
        "Office No. 611 to 617, Global Square, Deccan College Road, Yerawada, Pune, Maharashtra-411006",
      phone: "+91-44-42075580",
      fax: "+91-44-42075581",
    },
    {
      name: "Singapore",
      country: "Singapore",
      coordinates: [103.8501, 1.283], // More precise for Cecil Street area
    ...
    },
    {
      ...
      address:
        "Level 14, Hibiya Central Building, 1-2-9 Nishi Shimbashi, Minato-ku, Tokyo — 105-0003",
    ...
    },
    {
      ...
      address:
        "Menara Karya, Level 28, Jl. H R Rasuna Said, Kuningan, Jakarta, Indonesia 12950",
  ...
  const getPopupPosition = (coordinates: [number, number]) => {
    ...
    let left = Math.max(
      20,
      Math.min(x, window.innerWidth * 0.85 - popupWidth - 20),
    );
    let top = Math.max(
      20,
      Math.min(y, window.innerHeight * 0.9 - popupHeight - 20),
    );
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2 text-white">
                  <IconMail size={16} />
                  <a
                    href="mailto:ask@jcssglobal.com"
                    className="hover:text-orange-400 transition-colors"
                  >
                    ask@jcssglobal.com
                  </a>
          ...
          <div className="space-y-2 text-sm">
            <div>
              ...
              <span className="text-white ml-2">
                Bangalore, Ahmedabad, Chennai, Gurgaon, Hyderabad, Pune
              </span>
            </div>
            <div>
  ...
  if (isTablet) {
    return (
      <div
        id="contact-section"
        className="h-screen bg-[#042d4d] flex flex-col overflow-hidden"
      >
  ...
  return (
    <div className="bg-[#042d4d]">
      ...
      <div
        id="contact-section"
        className="min-h-screen max-w-screen bg-[#042d4d] pt-22"
      >
        {/* Top Section - 90% height */}
        <div
          ref={containerRef}
          onScroll={(e) => {
            handleScroll(); // Local scroll timeout logic
            globalHandleScroll(e); // Cinematic navigation logic
          }}
          className="h-[90vh] flex overflow-y-auto overflow-x-hidden"
        >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="bg-white/10 rounded-lg p-3 text-center mb-3">
                <div className="text-white text-xs mb-2">
                  2nd Floor, Dhiworth Plaza, # 20 Sankey Road, Bangalore – 560
                  020
                </div>
                <div className="flex flex-col gap-1">
                  <a
                    href="tel:+918023347000"
                    className="text-white hover:text-orange-500 transition-colors flex items-center justify-center gap-1 text-xs"
                  >
              ...
              <div className="space-y-2">
                <h4 className="text-orange-400 font-semibold text-xs text-center mb-2">
                  All Locations
                </h4>
                ...
                {selectedLocation && (
                  <div className="bg-white rounded-lg p-3 border-2 border-orange-400 shadow-lg animate-slide-down-slow animate-pulse-glow">
                    ...
                    <div className="text-gray-700 text-xs mb-2 leading-tight">
                      {selectedLocation.address}
                    </div>
                    <div className="flex flex-col gap-1">
                      <a
                  ...
                  .map((location, index) => (
                    <div
                      ...
                      style={{
                        ...
                        animation: selectedLocation
                          ? `fade-in-up 0.8s ease-out ${index * 0.1}s both`
                          : "none",
                      }}
                    >
                      ...
                      <div className="text-white/80 text-xs mb-2 leading-tight">
                        {location.address}
                      </div>
                      <div className="flex flex-col gap-1">
                        <a
